        ...
        class Model extends ObjectionModel {
            ...
            hasOnePolymorphic(modelName){
                ...
                const query = Model.query().where({
                    ...
                    [`${tableName}Type`]: this.constructor.name
                }).limit(1)
                ...
                return {
                    ...
                    create: async (options = {})=>{
                        options.path = this.path 
                        options[`${tableName}ID`] = this.id
                        options[`${tableName}Type`] = this.constructor.name
            ...
            belongsToPolymorphic(whitelist = []){
                ...
                const type = `${_.camelCase(this.constructor.name)}Type`;
                const id = `${_.camelCase(this.constructor.name)}ID`
                if(!this[type]){
                    return false
                }
